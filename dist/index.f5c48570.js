...
})({"8oF59":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
/*--------Firestore config for drum-----------*/ var _app = require("firebase/app");
...
let keyComponent = {
    ...
    watch: {
        'isPlaying': function() {
            if (!this.muteBeat && this.isPlaying == this.beatId) this.playKey();
        }
    },
    computed: {
        cssVars () {
        ...
        toggleActive () {
            switch(this.inst_selected){
                case 1:
                    ...
                    if (!this.muteBeat && this.prelistenBeat && this.state1) this.$emit('playSound1Event', this.keyId);
                    break;
                case 2:
                    this.state2 = !this.state2;
                    if (!this.muteBeat && this.prelistenBeat && this.state2) this.$emit('playSound2Event', this.keyId);
                    break;
                case 3:
                    this.state3 = !this.state3;
                    if (!this.muteBeat && this.prelistenBeat && this.state3) this.$emit('playSound3Event', this.keyId);
                    break;
            }
        },
        playKey () {
...
let layerComponent = {
    ...
    props: {
        /** sequencer controller */ unifiedControl: Boolean,
        n_bars: Number,
        inst_id: Number,
        duration: Array,
        total_duration: Number,
        /** state variables */ num_beats: Number,
        octaveLayer: Number,
        keyLayer: String,
        scaleLayer: String,
    ...
    methods: {
        ...
        clearLayer () {
            for(var idx = 0; idx < this.$refs.beats_refs.length; idx++)this.$refs.beats_refs[idx].clearAllKeys();
        },
        getElementSizes () {
            this.labels_width = this.$refs.labelsbox.clientWidth + 36;
            if (!this.unifiedControl) this.controller_width = this.$refs.controllerbox.clientWidth + 8;
            else this.controller_width = 0;
        }
    },
    mounted () {
...
let sequencerComponent = {
    ...
    data () {
        return {
            /** sequencer controller */ systemPlaying: false,
            bpm: 120,
            unifiedControl: true,
            n_bars: 1,
            inst_id: 1,
            ...
            /** unified controller */ allLayersOctave: 4,
            allLayersKey: 'C',
    ...
    methods: {
        /** sequencer controller */ addLayer (num_beats_input) {
        ...
        /** unified controller */ changeKey (num_key) {
            this.allLayersKey = num_key;
            for(idx in this.layers)this.layers[idx].keyLayer = this.allLayersKey;
        },
        changeScale (num_scale) {
            this.allLayersScale = num_scale;
            for(idx in this.layers)this.layers[idx].scaleLayer = this.allLayersScale;
        },
        moreOctave () {
            if (this.allLayersOctave < 6) {
                this.allLayersOctave++;
                for(idx in this.layers)this.layers[idx].octaveLayer = this.allLayersOctave;
            }
        },
        lessOctave () {
        ...
        togglePrelistenSystem () {
            ...
            for(idx in this.layers)this.layers[idx].prelistenLayer = this.prelistenSystem;
        },
        toggleMuteSystem () {
            this.muteSystem = !this.muteSystem;
            for(idx in this.layers)this.layers[idx].muteLayer = this.muteSystem;
        },
        clearSystem () {
            for(idx in this.layers)this.$refs.layers_refs[idx].clearLayer();
        },
        changeDuration (inst_id, duration) {
            this.duration[inst_id - 1] = 20 - duration * 4 + "n";
        },
...
var drum = Array(8);
_storage.getDownloadURL(_storage.ref(storage, 'gs://actam21.appspot.com/808_KICK_01_CLEAN_CFC.wav')).then(function(url) {
    drum[0] = new Tone.Player(url).toDestination();
});
_storage.getDownloadURL(_storage.ref(storage, 'gs://actam21.appspot.com/808_SNARE_01_CLEAN_CFC.wav')).then(function(url) {
    drum[1] = new Tone.Player(url).toDestination();
});
_storage.getDownloadURL(_storage.ref(storage, 'gs://actam21.appspot.com/808_TOM_HIGH_CLEAN_CFC.wav')).then(function(url) {
    drum[2] = new Tone.Player(url).toDestination();
});
_storage.getDownloadURL(_storage.ref(storage, 'gs://actam21.appspot.com/808_TOM_MID_CLEAN_CFC.wav')).then(function(url) {
    drum[3] = new Tone.Player(url).toDestination();
});
_storage.getDownloadURL(_storage.ref(storage, 'gs://actam21.appspot.com/808_H-CL_CLEAN_CFC.wav')).then(function(url) {
    drum[4] = new Tone.Player(url).toDestination();
});
_storage.getDownloadURL(_storage.ref(storage, 'gs://actam21.appspot.com/808_H-OH_CLEAN_CFC.wav')).then(function(url) {
    drum[5] = new Tone.Player(url).toDestination();
});
_storage.getDownloadURL(_storage.ref(storage, 'gs://actam21.appspot.com/808_CYM_01_CLEAN_CFC.wav')).then(function(url) {
    drum[6] = new Tone.Player(url).toDestination();
});
_storage.getDownloadURL(_storage.ref(storage, 'gs://actam21.appspot.com/808_COW_CLEAN_CFC.wav')).then(function(url) {
    drum[7] = new Tone.Player(url).toDestination();
});

},{"firebase/app":"f7Qy2","firebase/storage":"dos6T"}],"f7Qy2":[function(require,module,exports) {
...
},{"@firebase/app":"eWyLr","@parcel/transformer-js/src/esmodule-helpers.js":"9P1oC"}],"eWyLr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/component":"gpHTo","@firebase/logger":"eiCXw","@firebase/util":"bKNMP","@parcel/transformer-js/src/esmodule-helpers.js":"9P1oC"}],"gpHTo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/util":"bKNMP","@parcel/transformer-js/src/esmodule-helpers.js":"9P1oC"}],"bKNMP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"9P1oC"}],"9P1oC":[function(require,module,exports) {
...
},{}],"eiCXw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"9P1oC"}],"dos6T":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _storage = require("@firebase/storage");
parcelHelpers.exportAll(_storage, exports);

},{"@firebase/storage":"kQk35","@parcel/transformer-js/src/esmodule-helpers.js":"9P1oC"}],"kQk35":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/app":"eWyLr","@firebase/util":"bKNMP","@firebase/component":"gpHTo","@parcel/transformer-js/src/esmodule-helpers.js":"9P1oC"}]},["8oF59","8ZNvh"], "8ZNvh", "parcelRequiredf2d")
